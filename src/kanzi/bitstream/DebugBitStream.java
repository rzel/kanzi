...
{
    private final BitStream delegate;
    ...
    public DebugBitStream(BitStream bitstream)
    {
        this(bitstream, System.out, 80);
    }


    public DebugBitStream(BitStream bitstream, PrintStream out)
    {
        this(bitstream, out, 80);
    }


    public DebugBitStream(BitStream bitstream, PrintStream out, int width)
    {
        if (bitstream == null)
