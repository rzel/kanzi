        ...
        try
        {
            ...
            { 
               case "CONTEXTRESIZER" :
               {
                  ...
                  effect = new ContextResizer(w/2, h, w, vertical, action, geos, fastMode, debug);
                  test(effect, icon, "Filter - left half - "+geos+" seams", 0, 200, 150, 0, 0);
                  effect = new ContextResizer(w/2, h, w, vertical, action, geos, fastMode, debug);
                  test(effect, icon, "Filter - right half - "+geos+" seams", w/2, 300, 250, 0, 0);
                  effect = new ContextResizer(w, h/2, w, horizontal, action, geos, fastMode, debug);
                  ...
                  effect = new ContextResizer(w/2, h/2, w, vertical|horizontal, action, geos, fastMode, debug);
