...
func NewBlockCompressor() (*BlockCompressor, error) {
	...
	var function = flag.String("transform", "Block", "transform to use [None|Block*|Snappy|LZ4|BWT|BWTS|RLT]")
	...
	if *help == true {
		...
		printOut("-transform=<codec>   : transform to use [None|Block*|Snappy|LZ4|BWT|BWTS|RLT]", true)
