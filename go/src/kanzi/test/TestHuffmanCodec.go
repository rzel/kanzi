...
func main() {
	fmt.Printf("\nTestHuffmanCodec")
	var outputName = flag.String("output", "TestHuffmanCodec.log", "optional name of the output file (defaults to TestHuffmanCodec.log)")
	flag.Parse()
